# Implement a function called bitwise_xor() that takes two integers as arguments (in decimal) and returns the result of the XOR operation in decimal. You can use int() to convert a number from binary to decimal. In case any given argument is less than zero, raise a ValueError with the message:
